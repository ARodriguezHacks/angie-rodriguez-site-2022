...
_I'm in for a rollercoaster with the Rust language_

_Do I even program?_

_Can I even call myself a software engineer?_
...
2. After Rust is successfully installed, I ran this command to update to the latest Rust version
